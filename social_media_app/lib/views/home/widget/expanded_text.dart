  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          text,
          maxLines: isTextLong && !textExpandedprovider.isExpanded(postId) ? 6 : null,
          overflow:
              isTextLong && !textExpandedprovider.isExpanded(postId)
        ...
        if (isTextLong)
          GestureDetector(
            ...
            child: Text(
              textExpandedprovider.isExpanded(postId) ? "Read less" : "Read More",
